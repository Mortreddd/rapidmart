            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    ...
                    <svg class="rtl:rotate-180  w-3 h-3 mx-1 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                        ...
                        <span class="ms-1 text-lg font-medium text-secondary md:ms-2">Rejected Applicants</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <tbody id="table-applicant-body" class="bg-white text-left rounded-b-lg">
                @forelse($applicants as $applicant)
                    <tr class="text-black font-normal odd:bg-[#CAD9FF]">
                        ...
                        <td class="px-3 text-white bg-red-500 py-2 w-fit text-center">{{ $applicant->status }}</td>
