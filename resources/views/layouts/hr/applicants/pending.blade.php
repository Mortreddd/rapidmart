                ...
                @forelse($applicants as $applicant)
                    <tr class="text-black font-normal odd:bg-[#CAD9FF]">
                        ...
                        <td class="px-3 py-2">
                            ...
                            <a href="{{ route('applicant.view.edit', ['applicant_id' => $applicant->id ]) }}" class="appointment-button buttons rounded flex items-center justify-between gap-2 text-white my-2 hover:text-gray-200 p-3 bg-blue-600 hover:bg-blue-700 transition-colors duration-300 ease-in-out">
                                Appoint
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
